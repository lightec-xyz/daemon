...
func (_ZkbridgeSigner *ZkbridgeSignerCaller) Bytes32ToBytes(opts *bind.CallOpts, _data [32]byte) ([]byte, error) {
	var out []interface{}
	err := _ZkbridgeSigner.contract.Call(opts, &out, "bytes32ToBytes", _data)
...
//
// Solidity: function bytes32ToBytes(bytes32 _data) pure returns(bytes)
func (_ZkbridgeSigner *ZkbridgeSignerSession) Bytes32ToBytes(_data [32]byte) ([]byte, error) {
	return _ZkbridgeSigner.Contract.Bytes32ToBytes(&_ZkbridgeSigner.CallOpts, _data)
}

// Bytes32ToBytes is a free data retrieval call binding the contract method 0x4c0999c7.
//
// Solidity: function bytes32ToBytes(bytes32 _data) pure returns(bytes)
func (_ZkbridgeSigner *ZkbridgeSignerCallerSession) Bytes32ToBytes(_data [32]byte) ([]byte, error) {
	return _ZkbridgeSigner.Contract.Bytes32ToBytes(&_ZkbridgeSigner.CallOpts, _data)
}
