...
//
// Solidity: function decodeDepositTx(bytes rawBtcTx) pure returns(uint32[], uint64[], address receiveAddress, bytes32 txID, bytes[], bytes opData, bool chainFlag)
func (_BtcTxVerify *BtcTxVerifyCaller) DecodeDepositTx(opts *bind.CallOpts, rawBtcTx []byte) ([]uint32, []uint64, common.Address, [32]byte, [][]byte, []byte, bool, error) {
	var out []interface{}
	err := _BtcTxVerify.contract.Call(opts, &out, "decodeDepositTx", rawBtcTx)

	if err != nil {
		return *new([]uint32), *new([]uint64), *new(common.Address), *new([32]byte), *new([][]byte), *new([]byte), *new(bool), err
	}
...
//
// Solidity: function decodeDepositTx(bytes rawBtcTx) pure returns(uint32[], uint64[], address receiveAddress, bytes32 txID, bytes[], bytes opData, bool chainFlag)
func (_BtcTxVerify *BtcTxVerifySession) DecodeDepositTx(rawBtcTx []byte) ([]uint32, []uint64, common.Address, [32]byte, [][]byte, []byte, bool, error) {
	return _BtcTxVerify.Contract.DecodeDepositTx(&_BtcTxVerify.CallOpts, rawBtcTx)
}

// DecodeDepositTx is a free data retrieval call binding the contract method 0x7f2596fe.
//
// Solidity: function decodeDepositTx(bytes rawBtcTx) pure returns(uint32[], uint64[], address receiveAddress, bytes32 txID, bytes[], bytes opData, bool chainFlag)
func (_BtcTxVerify *BtcTxVerifyCallerSession) DecodeDepositTx(rawBtcTx []byte) ([]uint32, []uint64, common.Address, [32]byte, [][]byte, []byte, bool, error) {
	return _BtcTxVerify.Contract.DecodeDepositTx(&_BtcTxVerify.CallOpts, rawBtcTx)
}

// DecodeTx is a free data retrieval call binding the contract method 0xdae029d3.
//
// Solidity: function decodeTx(bytes rawBtcTx) pure returns(bytes32, (bytes32,uint32,bytes,bytes[],bytes4)[], (uint64,bytes)[])
func (_BtcTxVerify *BtcTxVerifyCaller) DecodeTx(opts *bind.CallOpts, rawBtcTx []byte) ([32]byte, []BtcTxLibTxIn, []BtcTxLibTxOut, error) {
	var out []interface{}
	err := _BtcTxVerify.contract.Call(opts, &out, "decodeTx", rawBtcTx)

	if err != nil {
		return *new([32]byte), *new([]BtcTxLibTxIn), *new([]BtcTxLibTxOut), err
	}

	out0 := *abi.ConvertType(out[0], new([32]byte)).(*[32]byte)
	out1 := *abi.ConvertType(out[1], new([]BtcTxLibTxIn)).(*[]BtcTxLibTxIn)
	out2 := *abi.ConvertType(out[2], new([]BtcTxLibTxOut)).(*[]BtcTxLibTxOut)
...
//
// Solidity: function decodeTx(bytes rawBtcTx) pure returns(bytes32, (bytes32,uint32,bytes,bytes[],bytes4)[], (uint64,bytes)[])
func (_BtcTxVerify *BtcTxVerifySession) DecodeTx(rawBtcTx []byte) ([32]byte, []BtcTxLibTxIn, []BtcTxLibTxOut, error) {
...
//
// Solidity: function decodeTx(bytes rawBtcTx) pure returns(bytes32, (bytes32,uint32,bytes,bytes[],bytes4)[], (uint64,bytes)[])
func (_BtcTxVerify *BtcTxVerifyCallerSession) DecodeTx(rawBtcTx []byte) ([32]byte, []BtcTxLibTxIn, []BtcTxLibTxOut, error) {
	return _BtcTxVerify.Contract.DecodeTx(&_BtcTxVerify.CallOpts, rawBtcTx)
}
...
//
// Solidity: function getDepthByAmount(uint64 amount, bool raiseIf, bool blockSigned) view returns(uint32)
func (_BtcTxVerify *BtcTxVerifyCaller) GetDepthByAmount(opts *bind.CallOpts, amount uint64, raiseIf bool, blockSigned bool) (uint32, error) {
	var out []interface{}
...
//
// Solidity: function getDepthByAmount(uint64 amount, bool raiseIf, bool blockSigned) view returns(uint32)
func (_BtcTxVerify *BtcTxVerifySession) GetDepthByAmount(amount uint64, raiseIf bool, blockSigned bool) (uint32, error) {
...
//
// Solidity: function getDepthByAmount(uint64 amount, bool raiseIf, bool blockSigned) view returns(uint32)
func (_BtcTxVerify *BtcTxVerifyCallerSession) GetDepthByAmount(amount uint64, raiseIf bool, blockSigned bool) (uint32, error) {
	return _BtcTxVerify.Contract.GetDepthByAmount(&_BtcTxVerify.CallOpts, amount, raiseIf, blockSigned)
}
...
// UpdateDepositVerifier is a paid mutator transaction binding the contract method 0xc98fa620.
//
// Solidity: function updateDepositVerifier(address addr, uint8 reserveHours) returns()
func (_BtcTxVerify *BtcTxVerifyTransactor) UpdateDepositVerifier(opts *bind.TransactOpts, addr common.Address, reserveHours uint8) (*types.Transaction, error) {
...
//
// Solidity: function updateDepositVerifier(address addr, uint8 reserveHours) returns()
func (_BtcTxVerify *BtcTxVerifySession) UpdateDepositVerifier(addr common.Address, reserveHours uint8) (*types.Transaction, error) {
...
//
// Solidity: function updateDepositVerifier(address addr, uint8 reserveHours) returns()
func (_BtcTxVerify *BtcTxVerifyTransactorSession) UpdateDepositVerifier(addr common.Address, reserveHours uint8) (*types.Transaction, error) {
	return _BtcTxVerify.Contract.UpdateDepositVerifier(&_BtcTxVerify.TransactOpts, addr, reserveHours)
}
...
// UpdateRedeemVerifier is a paid mutator transaction binding the contract method 0x60b135c4.
//
// Solidity: function updateRedeemVerifier(address addr, uint8 reserveHours) returns()
func (_BtcTxVerify *BtcTxVerifyTransactor) UpdateRedeemVerifier(opts *bind.TransactOpts, addr common.Address, reserveHours uint8) (*types.Transaction, error) {
...
//
// Solidity: function updateRedeemVerifier(address addr, uint8 reserveHours) returns()
func (_BtcTxVerify *BtcTxVerifySession) UpdateRedeemVerifier(addr common.Address, reserveHours uint8) (*types.Transaction, error) {
...
//
// Solidity: function updateRedeemVerifier(address addr, uint8 reserveHours) returns()
func (_BtcTxVerify *BtcTxVerifyTransactorSession) UpdateRedeemVerifier(addr common.Address, reserveHours uint8) (*types.Transaction, error) {
	return _BtcTxVerify.Contract.UpdateRedeemVerifier(&_BtcTxVerify.TransactOpts, addr, reserveHours)
}
