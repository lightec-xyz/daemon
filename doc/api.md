...
reScan
```
    curl -X POST -H "Content-Type: application/json"  -H "Authorization:eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJwdWJsaWNLZXkiOjIsImV4cCI6MTc0OTU2NTY3NX0.MBBAptLkmG9spEhznOUPRGbJmctnINkbZHuhVHNzED4"  -d '{"jsonrpc":"2.0","method":"'"zkbtc_reScan"'","params":[9871522, "ethereum"],"id":1}' http://127.0.0.1:9977
```
